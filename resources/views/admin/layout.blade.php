...
<head>
    ...
    <style>
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        /* Geometry mirrors the app chrome exactly, so the mark and wordmark sit in the
        ...
        .sidebar .dash-link { display:flex; align-items:center; gap:.6rem; text-decoration:none;
            color:#cdd2da; font-size:.86rem; font-weight:600; padding:.5rem .65rem; margin:.4rem 1.1rem .8rem;
    ...
    <div class="app">
        <aside class="sidebar">
            ...
            <nav>
                ...
                <a href="{{ route('admin.social') }}" class="{{ request()->routeIs('admin.social') ? 'active' : '' }}">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM6 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6zM18 22a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"/><line x1="8.6" y1="13.5" x2="15.4" y2="17"/><line x1="15.4" y1="6.5" x2="8.6" y2="10"/></svg>
                    Social
                </a>
