...
class EnvController extends Controller
{
    ...
    private function describe(string $key): string
    {
        static $map = [
            ...
            'GOOGLE_CLIENT_ID' => 'Google OAuth client ID. Set this + the secret to show "Continue with Google" on sign-in.',
            'GOOGLE_CLIENT_SECRET' => 'Google OAuth client secret.',
            'GOOGLE_REDIRECT_URI' => 'Google OAuth redirect URI, e.g. https://your-host/auth/google/callback (must match the Google console).',
